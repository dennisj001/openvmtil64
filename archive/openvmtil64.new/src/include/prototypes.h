...
void Compile_Set_CfrTilRspReg_FromReturnStackPointer(void);
void Compile_Set_ReturnStackPointer_FromCfrTilRspReg(void);
void Compile_CfrTilWord_Return(void);
void _Compile_Call_CfrTilWord(byte *address);
void Compile_Call_CfrTilWord(void);
...
void _Set_DspReg_FromDataStackPointer(void);
...
void CfrTil_PrintRspRegStack(void);
