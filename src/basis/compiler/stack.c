...
void
_Compile_Move_StackN_To_Reg ( int64 reg, int64 stackReg, int64 index )
{
    _Compile_Move_Rm_To_Reg ( reg, stackReg, index * CELL ) ;
}

void
_Compile_Move_Reg_To_StackN ( int64 stackReg, int64 index, int64 reg )
{
    _Compile_Move_Reg_To_Rm ( stackReg, reg, index * CELL ) ;
}

void
_Compile_Move_StackNRm_To_Reg ( int64 reg, int64 stackReg, int64 index )
{
...
void
_Compile_Move_Reg_To_StackNRm_UsingReg ( int64 stackReg, int64 index, int64 reg, int64 ureg )
{
...
void
_Compile_Stack_PushReg ( int64 stackReg, int64 reg )
{
    Compile_ADDI ( REG, stackReg, 0, sizeof (int64 ), BYTE ) ;
...
void
_Compile_Stack_PopToReg ( int64 stackReg, int64 reg )
{
...
void
Compile_Stack_PushEAX ( int64 stackReg )
{
    _Compile_Stack_PushReg ( stackReg, EAX ) ;
}

void
Compile_Move_TOS_To_EAX ( int64 stackReg )
{
    _Compile_Move_StackN_To_Reg ( EAX, stackReg, 0 ) ;
}

void
Compile_Move_EAX_To_TOS ( int64 stackReg )
{
    _Compile_Move_Reg_To_StackN ( stackReg, 0, EAX ) ;
}

void
Compile_Pop_To_EAX ( int64 stackReg )
{
    _Compile_Stack_PopToReg ( stackReg, EAX ) ;
}

void
Compile_Pop_ToEAX_AndCall ( int64 stackReg )
{
    _Compile_Stack_PopToReg ( stackReg, EAX ) ;
    _Compile_CallEAX ( ) ;
}
