...
CPrimitive CPrimitives [] = {
    ...
    //{ "cstackPush", Compile_DspPop_RspPush, IMMEDIATE, 0, "C", "Root" },
    ...
    { "rax_return", CfrTil_RAX_Return, IMMEDIATE, 0, "C", "Root" },

    { "{", CfrTil_Begin_C_Block, IMMEDIATE | KEYWORD, 0, "C_Syntax", "C" },
    { "}", CfrTil_End_C_Block, IMMEDIATE | KEYWORD, 0, "C_Syntax", "C" },
    { "s{", CfrTil_DbgSourceCode_Begin_C_Block, IMMEDIATE, 0, "C_Syntax", "C" },
    { "}s", CfrTil_DbgSourceCode_End_C_Block, IMMEDIATE, 0, "C_Syntax", "C" },
    ...
    { "_call", CfrTil_BlockRun, COMBINATOR, 0, "Combinators", "Root" },
    { "_run", CfrTil_BlockRun, COMBINATOR, 0, "Combinators", "Root" },
    ...
    { "_find", CfrTil_Postfix_Find, 0, 0, "Namespace", "Root" },
    //{ "find", CfrTil_Postfix_Find, IMMEDIATE, 0, "Namespace", "Root" },
    ...
    { "++", BigNum_PlusPlus, 0, 0, "BigNum", "Class" },
    { "-=", BigNum_MinusEqual, 0, 0, "BigNum", "Class" },
    { "--", BigNum_MinusMinus, 0, 0, "BigNum", "Class" },
    { "*", BigNum_Multiply, 0, 0, "BigNum", "Class" },
    { "*=", BigNum_MultiplyEqual, 0, 0, "BigNum", "Class" },
    { "^", BigNum_Power, 0, 0, "BigNum", "Class" },
    { "/", BigNum_Divide, 0, 0, "BigNum", "Class" },
    { "/=", BigNum_DivideEqual, 0, 0, "BigNum", "Class" },
    { "==", ( block ) BigNum_Equal, 0, 0, "BigNum", "Class" },
    { "<=", ( block ) BigNum_LessThanOrEqual, 0, 0, "BigNum", "Class" },
    { "<", ( block ) BigNum_LessThan, 0, 0, "BigNum", "Class" },
    { "sqrt", ( block ) BigNum_SquareRoot, 0, 0, "BigNum", "Class" },
    { "pow", ( block ) BigNum_Power, 0, 0, "BigNum", "Class" },
    { "^", ( block ) BigNum_Power, 0, 0, "BigNum", "Class" },
    { "**", ( block ) BigNum_Power, 0, 0, "BigNum", "Class" },
    { ">=", ( block ) BigNum_GreaterThanOrEqual, 0, 0, "BigNum", "Class" },
    { ">", ( block ) BigNum_GreaterThan, 0, 0, "BigNum", "Class" },
    { "==", ( block ) BigNum_LogicalEquals, 0, 0, "BigNum", "Class" },
    { "!=", ( block ) BigNum_LogicalDoesNotEqual, 0, 0, "BigNum", "Class" },
    { "_eprint", BigNum_EPrint, 0, 0, "BigNum", "Class" },
    { "_fprint", BigNum_FPrint, 0, 0, "BigNum", "Class" },
    ...
    { "pow", CfrTil_Power, CATEGORY_OP_ORDERED | INFIXABLE | KEYWORD, 0, "Int", "Root" },
    ...
    //{ "%=", CfrTil_ModEqual, IMMEDIATE | CATEGORY_OP_EQUAL | INFIXABLE | KEYWORD, 0, "Int", "Root" },
    ...
    { "hexIntPrint", CfrTil_HexPrintInt, 0, 0, "Int", "Root" },
    ...
    { "s{", CfrTil_DbgSourceCodeBeginBlock, IMMEDIATE, 0, "Debug", "Root" },
    { "}s", CfrTil_DbgSourceCodeEndBlock, IMMEDIATE, 0, "Debug", "Root" },
    { "s:", CfrTil_SourceCodeCompileOn, IMMEDIATE, 0, "Debug", "Root" },
    { ";s", CfrTil_SourceCodeCompileOff, IMMEDIATE, 0, "Debug", "Root" },
    { "dbgSourceCodeOn", _CfrTil_DbgSourceCodeCompileOn, IMMEDIATE, 0, "Debug", "Root" },
    { "dbgSourceCodeOff", _CfrTil_DbgSourceCodeCompileOff, IMMEDIATE, 0, "Debug", "Root" },
    { "scOff", CfrTil_DbgSourceCodeOff, 0, 0, "Debug", "Root" },
    ...
    { "$", shell, 0, 0, "Shell", "Root" },
    //{ "sh", shell, 0, 0, "Shell", "Root" },
    ...
    { "wordEval", CfrTil_Word_Eval, 0, 0, "Word", "Root" },
    ...
    { "_variable", CfrTil_Variable, 0, 0, "Compiler", "Root" },
    { "variable", CfrTil_Variable, IMMEDIATE, 0, "Compiler", "Root" },
    { "_constant", CfrTil_Constant, 0, 0, "Compiler", "Root" },
    { "constant", CfrTil_Constant, IMMEDIATE, 0, "Compiler", "Root" },
    ...
    { "quote", CfrTil_SingleQuote, KEYWORD, 0, "Compiler", "Root" },
    //{ "_tick", CfrTil_Tick, KEYWORD, 0, "Compiler", "Root" },
    { "_tick", CfrTil_SingleQuote, KEYWORD, 0, "Compiler", "Root" },
