...
CPrimitive CPrimitives [] = {
    ...
    { "++", "I.I", 5, INC, CfrTil_PlusPlus, IMMEDIATE | KEYWORD | CATEGORY_OP | CATEGORY_OP_1_ARG | CATEGORY_PLUS_PLUS_MINUS_MINUS, 0, 0, "C", "Root" },
    { "--", "I.I", 5, DEC, CfrTil_MinusMinus, IMMEDIATE | KEYWORD | CATEGORY_OP | CATEGORY_OP_1_ARG | CATEGORY_PLUS_PLUS_MINUS_MINUS, 0, 0, "C", "Root" },
    ...
    { "pick", 0, 0, 0, CfrTil_Pick, IMMEDIATE | KEYWORD | CATEGORY_OP_STACK, 0, 0, "Stack", "Root" },
