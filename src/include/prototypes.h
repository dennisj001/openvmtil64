...
BlockInfo *CfrTil_EndCombinator(int64 quotesUsed, int64 moveFlag);
...
void BI_Compile_TestCode_Reg(BlockInfo *bi, int8 reg, int8 size);
void BI_Set_LogicCode_tttn(BlockInfo *bi, int8 ttt, int8 negFlag);
void Compile_TestCode_Reg(Compiler *compiler, int8 reg, int8 size);
void BI_Compile_TestCode_ArgRegNum(BlockInfo *bi, int8 argRegNum);
void Compiler_Compile_TestCode_ArgRegNum(Compiler *compiler, int8 argRegNum);
void _Compile_GetTestLogicFromTOS(BlockInfo *bi);
void _Compile_LogicResultForStack(int64 reg, int8 ttt, Boolean negFlag);
BlockInfo *Compiler_Set_LogicCode(Compiler *compiler, int8 ttt, int8 negFlag);
void Compiler_Compile_BlockInfoTestLogic(Compiler *compiler, int8 reg, int8 ttt, int8 negFlag);
...
void Compiler_Setup_BI_tttn(Compiler *compiler, int8 ttt, int8 negFlag);
void _Compile_SETcc(int8 ttt, int8 negFlag, int8 reg);
void _Compile_SETcc_tttn_REG(Compiler *compiler, int8 ttt, int8 negFlag, int8 reg, int8 rm);
...
void _Compile_Jcc(int64 negFlag, int64 ttt, byte *jmpToAddr);
void Compile_Jcc(int64 bindex, int8 ttt);
void CfrTil_If(void);
...
void Word_SetHere_To_StackPushRegisterCode(Word *word);
