...
void _Compile_MOVZX_BYTE_REG(int8 reg);
...
void _Compile_SETcc_tttn_REG(int8 ttt, int8 negFlag, int8 reg);
void Compile_GetLogicFromTOS(BlockInfo *bi, byte *start);
int64 Compile_CheckReConfigureLogicInBlock(BlockInfo *bi, int8 overwriteFlag);
...
BlockInfo *_Set_JccLogicCode(Compiler *compiler);
void _Compile_LogicResultForStack(int64 reg, Boolean negFlag);
void _Compile_LogicalAnd(Compiler *compiler);
void Compile_LogicalAnd(Compiler *compiler);
BlockInfo *_Set_JccLogicCodeForNot(Compiler *compiler);
...
void _Block_Copy(byte *srcAddress, int64 bsize, int8 optFlag, int8 retFlag);
...
void Block_Copy(byte *dst, byte *src, int64 qsize, int8 retFlag);
...
int64 Compiler_CheckOptimize(Compiler *compiler);
...
void Word_SetHere_StackPushRegisterCode(Word *word);
...
void Interpret_C_Block_EndBlock(Word *word, byte *actualToken);
void Interpret_C_Block_BeginBlock(byte *actualToken);
...
Word *_Interpreter_DoWord_Default(Interpreter *interp, Word *word, int64 scratchPadIndex);
...
void BigNum_PopTwoOps_PushFunctionResult(mpf2andOutFunc func);
...
void CompileOptInfo_Init(Compiler *compiler, uint64 state);
