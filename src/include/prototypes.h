...
void Arrays_DoLoop_NonLisp(Lexer *lexer, byte *token, Word *arrayBaseObject, int64 objSize, Boolean saveCompileMode, Boolean variableFlag);
...
Word *_CfrTil_LocalWord(byte *name, int64 ctype, int64 ctype2, int64 ltype, int64 allocType);
...
void Arrays_DoLoop_Lisp(Word **pl1, Word *l1, Word *arrayBaseObject, int64 objSize, Boolean saveCompileMode, Boolean variableFlag);
int64 _LO_Apply_ArrayArg(ListObject **pl1, int64 i);
