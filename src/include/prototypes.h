...
void _CfrTil_Namespaces_PurgeWordIfContainsName(byte *name);
void CfrTil_Namespaces_PurgeWordIfContainsName(void);
int64 Word_RemoveIfStringEqualExactName(Symbol *symbol, byte *name);
void _CfrTil_Namespaces_PurgeWordExactName(byte *name);
void CfrTil_Namespaces_PurgeWordExactName(void);
