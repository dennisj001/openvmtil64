...
ListObject *LO_Apply(ListObject *l0, ListObject *lfunction, ListObject *largs, Boolean *applyFlag);
ListObject *_LO_EvalList(ListObject *l0, ListObject *locals, Boolean *applyFlag);
