...
void Word_RecycleWordList(Word *scWord);
void CfrTil_WordList_RecycleInit(CfrTil *cfrtil, Word *word, Boolean recycle, Boolean force, Boolean saveWord0);
...
void Word_SetCodingHere_And_ClearPreviousUseOf_This_SCA(Word *word, Boolean clearPreviousFlag);
