...
void Compiler_WordList_RecycleInit(Compiler *compiler);
int64 Compiler_BlockLevel(Compiler *compiler);
void Compiler_Init(Compiler *compiler, uint64 state, Boolean recycle);
...
int64 String_CheckWordSize(byte *str, int64 wl, Boolean punctFlag);
...
ListObject *_LO_New(uint64 ltype, uint64 ctype, uint64 ctype2, byte *value, Word *word, uint64 allocType, int64 tokenStartReadLineIndex, int64 scIndex);
void LO_Quote(void);
