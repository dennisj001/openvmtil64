...
void _CfrTil_MachineCodePrimitive_NewAdd(const char *name, uint64 morphismAttributes, int64 objectAttributes, block *callHook, byte *function, int64 functionArg, const char *nameSpace, const char *superNamespace);
...
void CfrTil_Do_ClassField(Word *word, Boolean isForwardDotted, Boolean rvalueFlag);
...
void CfrTil_Do_AccumulatedAddress(Word *word, byte *accumulatedAddress, int64 offset, Boolean rvalueFlag);
...
void _CfrTil_ArrayBegin(Boolean lispMode, Word **pl1, int64 *i);
...
Word *DataObject_New(uint64 type, Word *word, byte *name, uint64 morphismAttributes, uint64 objectAttributes, uint64 lispAttributes, int64 index, int64 value, int allocType, int64 tsrli, int64 scwi);
...
Word *CfrTil_ClassField_New(byte *token, Class *aclass, int64 size, int64 offset);
...
void CfrTil_Parse_Error(byte *msg, byte *token);
...
void _CfrTil_CPrimitiveNewAdd(const char *name, byte *pb_TypeSignature, uint64 opInsnGroup, uint64 opInsCode, block b, uint64 morphismAttributes, uint64 objectAttributes, uint64 lispAttributes, const char *nameSpace, const char *superNamespace);
...
void _CfrTil_SetAsInNamespace(Namespace *ns);
...
void CfrTil_WordList_Push(Word *word, Boolean inUseFlag);
...
void CfrTil_WordList_Show(Word *word, byte *prefix, Boolean inUseOnlyFlag, Boolean showInDebugColors);
void _CfrTil_SC_WordList_Show(byte *prefix, Boolean inUseOnlyFlag, Boolean showInDebugColors);
void CfrTil_SC_WordList_Show(void);
...
void CfrTil_Finish_WordSourceCode(CfrTil *cfrtil, Word *word);
...
int64 CfrTil_Get_ObjectByteSize(Word *word);
void CfrTil_Set_Namespace_ObjectByteSize(Namespace *ns, int64 obsize);
int64 CfrTil_Get_Namespace_SizeVar_Value(Namespace *ns);
/* src/basis/linux.c */
...
void _OVT_SimpleFinal_Key_Pause(byte *msg, Boolean useKey);
...
void CfrTil_Word_ClassStructure_PrintData(Word *word);
...
void _CfrTil_Move(int64 *address, int64 value, int64 lvalueSize);
...
int64 _CfrTil_Parse_Typedef_Field(void);
