...
void Interpreter_DoInfixWord(Interpreter *interp, Word *word, int64 tsrli, int64 scwi);
void _Interpreter_DoPrefixWord(Context *cntx, Interpreter *interp, Word *word);
void Interpreter_DoPrefixWord(Context *cntx, Interpreter *interp, Word *word, int64 tsrli, int64 scwi);
void Interpreter_C_PREFIX_RTL_ARGS_Word(Word *word, int64 tsrli, int64 scwi);
...
void _LC_ReadEvalPrint_ListObject(int64 parenLevel, int64 continueFlag);
...
void _LC_ClearTemporariesNamespace(LambdaCalculus *lc);
void _LC_ClearInternalNamespace(LambdaCalculus *lc);
void LC_ClearTemporaryNamespace(void);
void LC_ClearInternalNamespace(void);
void LC_LispNamespaceOff(void);
void LC_LispNamespaceOn(void);
LambdaCalculus *_LC_Init_Runtime(LambdaCalculus *lc);
LambdaCalculus *_LC_NewInit(LambdaCalculus *lc);
LambdaCalculus *LC_NewInit(void);
LambdaCalculus *LC_RuntimeInit(void);
LambdaCalculus *_LC_New(void);
