...
void Compile_C_TypeDeclaration(Namespace *ns, byte *token1);
...
void CfrTil_DeleteDebugInfo(Word *word);
void _CfrTil_FinishWordDebugInfo(Word *word, Boolean flag);
...
Word *Get_SourceCodeWord(Debugger *debugger);
