...
Namespace *_Class_New(byte *name, uint64 objectType, int64 cloneFlag);
...
int64 CfrTil_Get_NamespaceObjectByteSize(Namespace *ns);
/* src/basis/linux.c */
...
Boolean DBG_SHOULD_WE_DO_SETUP(Debugger *debugger, Word *word, byte *address, Boolean forceFlag);
