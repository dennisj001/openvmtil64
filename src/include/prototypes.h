...
void CfrTil_Do_ClassField(Word *word);
...
void CfrTil_Do_Variable(Word *word);
void _Do_LiteralValue(int64 value);
void CfrTil_Do_LiteralWord(Word *word);
void Do_AccumulatedAddress(byte *accumulatedAddress, int64 offset, Boolean rvalueFlag);
