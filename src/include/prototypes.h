...
int8 CalculateModRegardingDisplacement(int8 mod, int64 disp);
uint8 CalculateModRmByte(int8 mod, int8 reg, int8 rm, int8 sib, int64 disp);
...
void _Compile_ImmDispData(int64 immDisp, int8 size, int8 forceFlag);
void Compile_Int8(int64 opCode);
uint8 _Calculate_Rex_With_Sib(int8 reg, int8 scale, int8 index, int8 base, int8 rex_w_flag);
uint8 Calculate_Rex(int8 reg, int8 rm, int8 rex_w_flag);
void _Compile_Write_Instruction_X64(int8 rex, uint8 opCode0, uint8 opCode1, int8 modRm, int16 controlFlags, int8 sib, int64 disp, int8 dispSize, int64 imm, int8 immSize);
void Compile_CalcWrite_Instruction_X64(uint8 opCode0, uint8 opCode1, int8 mod, int8 reg, int8 rm, int16 controlFlags, int8 sib, int64 disp, int8 dispSize, uint64 imm, int8 immSize);
void _Compile_X_Group1(int8 code, int8 toRegOrMem, int8 mod, int8 reg, int8 rm, int8 sib, int64 disp, int8 osize);
void _Compile_X_Group1_Reg_To_Reg(int8 code, int8 dstReg, int64 srcReg);
...
void _Compile_Group2(int8 mod, int8 regOpCode, int8 rm, int64 controlFlags, int8 sib, int64 disp, int64 imm);
void _Compile_Group2_CL(int8 mod, int8 regOpCode, int8 rm, int8 sib, int64 disp);
void _Compile_Group3(int8 code, int8 mod, int8 rm, int8 controlFlags, int8 sib, int64 disp, int64 imm, int8 size);
void _Compile_Group5(int8 code, int8 mod, int8 rm, int8 sib, int64 disp, int8 size);
void Compile_X_Group5(Compiler *compiler, int64 op);
void _Compile_LEA(int8 reg, int8 rm, int8 sib, int64 disp);
void _Compile_TEST_Reg_To_Reg(int8 dstReg, int64 srcReg, int8 size);
void Compile_TEST_Reg_To_Reg(int8 dstReg, int64 srcReg);
void _Compile_IMUL(int8 mod, int8 reg, int8 rm, int8 sib, int64 disp, uint64 imm);
void Compile_IMULI(int8 mod, int8 reg, int8 rm, int8 sib, int64 disp, int64 imm);
void Compile_IMUL(int8 mod, int8 reg, int8 rm, int8 controlFlags, int8 sib, int64 disp);
void _Compile_Test(int8 mod, int8 reg, int8 rm, int8 controlFlags, int64 disp, int64 imm);
void _Compile_Move(int8 mod, int8 reg, int8 rm, int8 sib, int64 disp);
void Compile_Move_WithSib(int8 rex, int8 mod, int8 reg, int8 rm, int8 controlFlags, int8 scale, int8 index, int8 base);
void Compile_Move_Reg_To_Rm(int8 dstRmReg, int8 srcReg, int64 rmRegDisp);
void Compile_Move_Rm_To_Reg(int8 dstReg, int8 srcRmReg, int64 disp);
void Compile_Move_Reg_To_Reg(int8 dstReg, int64 srcReg);
void Compile_MoveImm(int8 direction, int8 rm, int8 sib, int64 disp, int64 imm, int8 immSize);
void Compile_MoveImm_To_Reg(int8 reg, int64 imm, int8 immSize);
void Compile_MoveImm_To_Mem(int8 rm, int64 imm, int8 immSize);
void Compile_MoveMemValue_To_Reg(int8 reg, byte *address, int8 iSize);
void Compile_MoveMemValue_ToReg_ThruReg(int8 reg, byte *address, int8 iSize, int8 thruReg);
void Compile_MoveReg_ToAddress_ThruReg(int8 reg, byte *address, int8 thruReg);
byte *Calculate_Address_FromOffset_ForCallOrJump(byte *address);
int32 _CalculateOffsetForCallOrJump(byte *compileAtAddress, byte *jmpToAddr, int8 offsetSize);
...
void _Compile_JumpToReg(int8 reg);
void _Compile_UninitializedJumpEqualZero(void);
void _Compile_UninitializedJmpOrCall(int8 jmpOrCall);
void _Compile_JumpWithOffset(int64 disp);
void _Compile_UninitializedCall(void);
void _Compile_UninitializedJump(void);
void _Compile_CallThru(int8 reg, int8 regOrMem);
void Compile_CallThru_AdjustRSP(int8 reg, int8 regOrMem);
void Compile_Call(byte *address);
void _Compile_Call_ToAddressThruReg_TestAlignRSP(int8 thruReg);
void Compile_Call_ToAddressThruReg_TestAlignRSP(byte *address, int8 thruReg);
...
void Compile_CallWord_X84_ABI_RSP_ADJUST(Word *word);
...
void _Compile_MOVZX_BYTE_REG(int8 reg, int8 rm);
...
void _Compile_RspReg_Store(void);
...
void _Compile_Set_CAddress_WithRegValue_ThruReg(byte *address, int8 reg, int8 thruReg);
void Compile_Peek(Compiler *compiler, int8 stackReg);
void Compile_Store(Compiler *compiler, int8 stackReg);
void Compile_Poke(Compiler *compiler, int8 stackReg);
void Compile_AtEqual(int8 stackReg);
...
int64 CfrTil_WhileCombinator(void);
int64 CfrTil_DoWhileCombinator(void);
...
Cpu *CfrTil_CpuState_SaveCopyCurrent(void);
...
void _Compile_Stack_Drop(int8 stackReg);
void _Compile_Stack_DropN(int8 stackReg, int64 n);
void _Compile_DropN_Rsp(int64 n);
void _Compile_SetStackN_WithObject(int8 stackReg, int64 n, int64 obj);
void _Compile_Stack_Push(int8 stackReg, int64 obj);
void _Compile_StackPtrLValue_PushObj(uint64 stkPtrLvalue, int8 tempStkReg, int64 obj);
void _Compile_StackPtrLValue_PopToReg(uint64 stkPtrLvalue, int8 tempStkReg, int8 reg);
void _Compile_Move_StackN_To_Reg(int8 reg, int8 stackReg, int64 index);
void _Compile_Move_Reg_To_StackN(int8 stackReg, int64 index, int8 reg);
void _Compile_Move_StackNRm_To_Reg(int8 reg, int8 stackReg, int64 index);
void _Compile_Move_Reg_To_StackNRm_UsingReg(int8 stackReg, int64 index, int8 reg, int8 ureg);
void _Compile_Stack_PushReg(int8 stackReg, int8 reg);
void _Compile_Stack_PopToReg(int8 stackReg, int8 reg);
void Compile_Stack_PushACCUM(int8 stackReg);
...
void _Compile_Stack_Swap(int8 stackReg);
...
void BI_Set_setTtnn(BlockInfo *bi, int8 setTtn, int8 setNegFlag, int8 jccTtt, int8 jccNegFlag);
void Compiler_Set_BI_setTtnn(Compiler *compiler, int8 setTtn, int8 setNegFlag, int8 jccTtt, int8 jccNegFlag);
void _Compile_TestCode(int8 reg, int8 size);
void BI_CompileRecord_TestCode_Reg(BlockInfo *bi, int8 reg, int8 size);
void BI_CompileRecord_TestCode_ArgRegNum(BlockInfo *bi, int8 argRegNum);
BlockInfo *Compiler_BI_CompileRecord_TestCode_Reg(Compiler *compiler, int8 reg, int8 size);
int8 _COI_GetReg(CompileOptimizeInfo *optInfo, int8 regNumber);
void Compiler_BI_CompileRecord_TestCode_ArgRegNum(Compiler *compiler, int8 argRegNum);
void Compiler_BI_CompileRecord_TestCode_Set_setTtnn(Compiler *compiler, int8 reg, int8 setTtn, int8 setNegFlag, int8 jccTtt, int8 jccNegFlag);
void _Compile_GetTestLogicFromTOS(BlockInfo *bi);
void _Compile_LogicResultForStack(int64 reg, int8 setTtn, Boolean setNegFlag);
BlockInfo *Compiler_Set_LogicCode(Compiler *compiler, int8 setTtn, int8 setNegFlag, int8 jccTtt, int8 jccNegFlag);
...
void _Compile_SETcc(int8 setTtn, int8 setNegFlag, int8 reg);
void _Compile_SETcc_setTtnn_REG(Compiler *compiler, int8 setTtn, int8 setNegFlag, int8 jccTtt, int8 jccNegFlag, int8 reg, int8 rm);
void Compile_Cmp_Set_setTtnn_Logic(Compiler *compiler, int8 setTtn, int8 setNegateFlag, int8 jccTtt, int8 jccNegFlag);
...
void Compile_TestLogicAndStackPush(Compiler *compiler, int8 reg, int8 setTtn, int8 setNegFlag, int8 jccTtt, int8 jccNegFlag);
void Compile_Logical_X(Compiler *compiler, int64 op, int8 setTtn, int8 setNegateFlag, int8 jccTtt, int8 jccNegFlag);
void Compile_LogicalNot(Compiler *compiler);
void _Compile_Jcc(int64 setNegFlag, int64 setTtn, byte *jmpToAddr);
void _BI_Compile_Jcc(BlockInfo *bi, byte *address);
void BI_Compile_Jcc(BlockInfo *bi, int8 setTtn, byte *address);
void Compiler_Compile_Jcc(Compiler *compiler, int64 bindex, int8 setTtn);
void CfrTil_If(void);
...
void _Do_Literal(int64 value);
void _Namespace_DoNamespace(Namespace *ns, int64 immFlag);
DObject *_CfrTil_Do_DynamicObject_ToReg(DObject *dobject0, int8 reg);
void CfrTil_Do_DynamicObject(DObject *dobject0, int8 reg);
...
BlockInfo *BI_Block_Copy(BlockInfo *bi, byte *dstAddress, byte *srcAddress, int64 bsize, int8 optFlag);
...
int64 _CfrTil_AdjustLabels(byte *srcAddress);
...
void Compile_StandardArg(Word *word, int8 reg, Boolean rvalueFlag, byte *setHere);
void Compile_StandardUnoptimized(Compiler *compiler);
...
int8 CheckForRegisterVariable(Compiler *compiler, int8 reg);
void Setup_MachineCodeInsnParameters(Compiler *compiler, int8 direction, int8 mod, int8 reg, int8 rm, int64 disp, int64 immediate, int8 immSize, int8 forceSet);
void Word_Set_StackPushRegisterCode_To_Here(Word *word);
void _SetHere_To_Word_StackPushRegisterCode(Word *word, Boolean setDebugFlag);
void Word_Check_SetHere_To_StackPushRegisterCode(Word *word, Boolean setDebugFlag);
void Compile_Optimize_OpEqual(Compiler *compiler);
...
int64 Do_NextArrayWordToken(Word *word, byte *token, Word *arrayBaseObject, int64 objSize, int64 saveCompileMode, int64 *variableFlag);
...
/* basis/core/syntax.c */
int64 _Interpret_CheckEqualBeforeSemi_LValue(byte *nc);
int64 Interpret_CheckEqualBeforeSemi_LValue(Word *word);
void Interpret_DoParenthesizedRValue(void);
void Interpret_C_Block_EndBlock(Word *word, byte *tokenToUse, Boolean insertFlag);
void Interpret_C_Block_BeginBlock(byte *tokenToUse, Boolean insertFlag);
int64 CfrTil_Interpret_C_Blocks(int64 blocks, Boolean takesAnElseFlag, Boolean semicolonEndsThisBlock);
...
Word *_DataObject_New(uint64 type, Word *word, byte *name, uint64 ctype, uint64 ctype2, uint64 ltype, int64 index, int64 value, int allocType, int64 tsrli, int64 scwi);
...
void _Class_Object_Init(Word *word, Namespace *ns);
...
Word *_CfrTil_LocalWord(byte *name, int64 index, int64 ctype, int64 ctype2, int64 ltype, int64 allocType);
int64 ParameterVarOffset(Word *word);
Word *CfrTil_LocalWord(byte *name, int64 ctype, int64 allocType);
...
void CfrTil_RecycleWordList(Word *scWord);
void CfrTil_WordList_Init(CfrTil *cfrtil, Word *word, Boolean saveWord0);
...
void CfrTil_Debugger_State_CheckSaveShow(void);
void CfrTil_Debugger_SaveCpuState(void);
void CfrTil_PrintReturnStackWindow(void);
...
void _MemList_FreeExactType(dllist *list, int64 allocType);
void _MemList_FreeVariousTypes(dllist *list, int64 allocType);
...
void NBA_AccountRemainingAndShow(NamedByteArray *nba, int8 flag);
void OVT_ShowNBAs(OpenVmTil *ovt, int64 flag);
int64 _OVT_ShowPermanentMemList(OpenVmTil *ovt);
void _Calculate_TotalNbaAccountedMemAllocated(OpenVmTil *ovt, int8 showFlag);
...
void DLList_RecycleWordList(dllist *list);
...
void _CfrTil_CPrimitiveNewAdd(const char *name, uint64 opInsnGroup, uint64 opInsCode, block b, uint64 ctype, uint64 ctype2, uint64 ltype, const char *nameSpace, const char *superNamespace);
...
void _CfrTil_WordAccounting_Print(byte *functionName);
...
/* basis/core/dllist.c */
dobject *_dllist_PushNew_M_Slot_Node(dllist *list, int64 dobjType, int64 allocType, int64 m_slots, ...);
...
void _List_PushNew_1Value(dllist *list, int64 type, int64 value, int64 allocType);
...
Word *_Interpreter_DoWord_Default(Interpreter *interp, Word *word0, int64 tsrli, int64 scwi);
void Interpreter_DoPrefixWord(Context *cntx, Interpreter *interp, Word *word);
void _Interpreter_DoWord(Interpreter *interp, Word *word, int64 tsrli, int64 scwi);
...
byte *_Lexer_NextNonDebugOrCommentTokenWord(Lexer *lexer, Boolean evalFlag, Boolean peekFlag);
byte *_Lexer_PeekNextNonDebugTokenWord(Lexer *lexer, int64 evalFlag);
...
void Lexer_SetBasicTokenDelimiters(Lexer *lexer, byte *delimiters, uint64 allocType);
...
/* basis/core/cstack.c */
void Stack_Print_AValue_WordName(Stack *stack, int64 i, byte *stackName, byte *buffer);
void Stack_Print_AValue(uint64 *stackPointer, int64 i, byte *stackName, byte *buffer);
...
int64 _Stack_DropN(Stack *stack, int64 n);
int64 _Stack_Top(Stack *stack);
...
void Stack_SetStackMax(Stack *stack, int64 value);
...
void Debugger_ShowEffects(Debugger *debugger, int8 stepFlag, int8 forceFlag);
byte *Debugger_ShowSourceCodeLine(Debugger *debugger, Word *word, byte *token0, int64 twAlreayUsed);
...
void _Debugger_PostShow(Debugger *debugger, Word *word, int8 force);
...
void _Namespace_FreeNamespacesStack(Stack *stack);
...
HistorySpace *_HistorySpace_Init(OpenVmTil *ovt, int64 reset);
...
void _CfrTil_Contex_NewRun_2(CfrTil *cfrTil, ContextFunction_2 contextFunction, byte *arg, int64 arg2);
...
Word *_Word_Create(byte *name, uint64 ctype, uint64 ctype2, uint64 ltype, uint64 allocType);
void Word_SetLocation(Word *word);
Word *_Word_New(byte *name, uint64 ctype, uint64 ctype2, uint64 ltype, int8 addToInNs, Namespace *addToNs, uint64 allocType);
Word *Word_New(byte *name);
void Word_PrintOffset(Word *word, int64 increment, int64 totalIncrement);
...
mpfr_t *BigNum_GetPrintfPrecision_BigNum(void);
...
void _SetPreHere_ForDebug(byte *index);
void SetPreHere_ForDebug(byte *index);
void ByteArray_SetHere_AndForDebug(ByteArray *ba, byte *index, Boolean forDebugFlag);
...
void ByteArray_AppendCopyItem(ByteArray *ba, int64 size, int64 data);
...
Word *_CfrTil_CopyDuplicatesAndPush(Word *word0);
...
Word *_CfrTil_WordList(int64 n);
Word *CfrTil_WordList(int64 n);
...
void _Compiler_CompileAndRecord_Word0_PushReg(int8 reg);
...
void _Interpret_UntilFlagged(Interpreter *interp, int64 doneFlags);
...
void Word_SetCoding(Word *word, byte *address, Boolean setCodingFlag);
void WordList_SetCoding(int64 index, byte *address);
void SC_List_AdjustAddress(dlnode *node, byte *address, byte *newAddress);
void SC_ListClearAddress(dlnode *node, byte *address);
void _Word_Clear_PreviousUseOf_A_SCA(Word *word, byte *coding);
void Word_Clear_PreviousUseOf_A_SCA(Word *word);
void _Word_SetCoding_And_ClearPreviousUseOf_A_SCA(Word *word, byte *index, Boolean clearPreviousFlag);
void Word_SetCodingHere_And_ClearPreviousUseOf_Here_SCA(Word *word, Boolean clearPreviousFlag);
Word *_CfrTil_WordList_TopWord(void);
void _CfrTil_WordList_PopWords(int64 n);
void CfrTil_WordLists_PopWord(void);
void _DWL_ShowWord_Print(Word *word, int64 index, byte *prefix, byte *coding, byte *sourceCoding, byte *newSourceCoding, int64 scwiDiff, Boolean iuoFlag);
...
void Compiler_SC_WordList_Show(byte *prefix, int8 inUseOnlyFlag, Boolean showInDebugColors);
...
void CfrTil_SourceCode_InitEnd(CfrTil *cfrtil);
void CfrTil_SourceCode_InitStart(CfrTil *cfrtil);
...
int64 _Debugger_SetupReturnStackCopy(Debugger *debugger, int64 size, int8 showFlag);
...
byte *_String_Insert_AtIndexWithColors(byte *token, int64 ndx, Colors *c);
byte *String_ReadLineToken_HighLight(byte *token);
byte *_String_AppendConvertCharToBackSlashAtIndex(byte *dst, byte c, int64 *index, int64 quoteMode);
...
int64 _CfrTil_StrTok(byte *inBuffer);
...
byte *_String_HighlightTokenInputLine(byte *nvw, int8 lef, int64 leftBorder, int64 tokenStart, byte *token, int64 rightBorder, int8 ref, int8 dl);
...
void _OpenVmTil_CalculateMemSpaceSizes(OpenVmTil *ovt, int64 restartCondition, int64 totalMemSizeTarget);
...
void _DObject_ValueDefinition_Init(Word *word, uint64 value, uint64 funcType, byte *function, int64 arg);
void DObject_Finish(Word *word);
Word *_DObject_Init(Word *word, uint64 value, uint64 ftype, byte *function, int64 arg);
Word *_DObject_New(byte *name, uint64 value, uint64 ctype, uint64 ctype2, uint64 ltype, uint64 ftype, byte *function, int64 arg, int64 addToInNs, Namespace *addToNs, uint64 allocType);
...
int64 Debugger_Disassemble(Debugger *debugger, byte *address, int64 number, int64 cflag);
...
void LinuxInit(void);
/* basis/exception.c */
int64 _OpenVmTil_ShowExceptionInfo(void);
...
void OVT_SetExceptionMessage(OpenVmTil *ovt);
void _OVT_SigLongJump(sigjmp_buf *jb);
void OVT_SigLongJump(byte *restartMessage, sigjmp_buf *jb);
void OVT_Throw(int signal, int64 restartCondition, int8 pauseFlag);
...
void CfrTil_Exception(int64 signal, byte *message, int64 restartCondition);
/* basis/types.c */
...
void Debugger_CfrTilRegisters(Debugger *debugger);
...
void CfrTil_CharacterDump(byte *address, int64 number);
void _CfrTil_AByteDump(byte aByte);
void CfrTil_NByteDump(byte *address, int64 number);
...
ListObject *LO_Apply(ListObject *lfirst, ListObject *lfunction, ListObject *largs, Boolean applyFlag);
ListObject *LO_EvalList(ListObject *l0, ListObject *locals, Boolean applyFlag);
ListObject *_LO_Eval(ListObject *l0, ListObject *locals, Boolean applyFlag);
ListObject *_LO_EvalSymbol(ListObject *l0, ListObject *locals);
ListObject *_LO_EvalList(ListObject *lorig, ListObject *locals, Boolean applyFlag);
...
ListObject *_LO_Read_DoWord(Word *word, int64 qidFlag, int64 scwi);
ListObject *_LO_Read_DoToken(byte *token, int64 qidFlag, int64 scwi);
ListObject *LO_Read_DoToken(byte *token, int64 qidFlag, int64 scwi);
ListObject *LO_Read_DoSplice(ListObject *l0, ListObject *lnew);
...
ListObject *_LO_New(uint64 ltype, uint64 ctype, uint64 ctype2, byte *name, byte *value, Word *word, uint64 allocType, int64 rl_Index, int64 scwi);
void LC_QuoteQuasiQuoteRepl(uint64 state, Boolean doReplFlag);
void LO_Quote(void);
...
ListObject *_LO_Read_ListObject(int64 parenLevel);
void _LO_ReadEvalPrint_ListObject(int64 parenLevel, int64 continueFlag);
void LO_ReadEvalPrint_ListObject(void);
void LO_ReadEvalPrint_AfterAFirstLParen(void);
...
void _LC_Init(LambdaCalculus *lc, int64 newFlag);
void LC_Clear(int64 deleteFlag);
LambdaCalculus *_LC_New(int64 forceInitFlag);
LambdaCalculus *LC_New(void);
void _LC_Reset(int64 flag);
void LC_Reset(void);
...
void _CfrTil_CompileCallGoto(byte *name, uint64 type);
void _CfrTil_Goto(byte *name);
void _CfrTil_GotoLabel(byte *name);
...
void CompileTime_Location(void);
void Word_Compile_CurrentRunningWord(void);
void Word_Namespace(void);
void CfrTil_Keyword(void);
void CfrTil_Immediate(void);
void CfrTil_StackVariable(void);
void CfrTil_Syntactic(void);
...
int64 _CfrTil_PrintWords(int64 state);
...
int64 _CfrTil_PrintVariables(int64 nsStatus);
...
void CfrTil_If_PrefixCombinators(void);
void CfrTil_DoWhile_PrefixCombinators(void);
