...
void CfrTil_InterpretNBlocks(int64 blocks, Boolean takesLParenAsBlockFlag, Boolean alsoTakesSemicolonToEndBlock, int8 blocksBegun);
...
/* basis/sourceCode.c */
Word *DWL_Find(dllist *list, Word *iword, byte *address, byte *name, int64 fromTop, int64 takeFirstFind, byte *newAddress);
