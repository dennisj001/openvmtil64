...
void _Compile_InstructionX86(int8 rex, int8 opCode, int8 mod, int8 reg, int8 rm, int8 controlFlag, int8 sib, int64 disp, int8 dispSize, int64 imm, int8 immSize);
void _Compile_InstructionX64(int8 rex, int16 opCode, int8 modRm, int64 controlFlag, int8 sib, int64 disp, int8 dispSize, int64 imm, int8 immSize);
...
void _Compile_IMUL(int64 mod, int8 reg, int8 rm, int controlFlags, int8 sib, int64 disp);
...
void OVT_MemLeakAccount(Boolean check);
void MLA(void);
