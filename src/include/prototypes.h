...
uint8 _Calculate_Rex_With_Sib(Boolean reg, Boolean scale, Boolean index, Boolean base, Boolean rex_w_flag);
uint8 Calculate_Rex(Boolean reg, Boolean rm, Boolean rex_w_flag);
...
void Compile_CalcWrite_Instruction_X64(uint8 opCode0, uint8 opCode1, Boolean mod, Boolean reg, Boolean rm, int16 controlFlags, Boolean sib, int64 disp, Boolean dispSize, uint64 imm, Boolean immSize);
...
void Compile_IMULI(Boolean mod, Boolean reg, Boolean rm, Boolean sib, int64 disp, int64 imm);
...
void _Compile_Move(Boolean mod, Boolean reg, Boolean rm, Boolean sib, int64 disp);
void Compile_Move_WithSib(Boolean rex, Boolean mod, Boolean reg, Boolean rm, Boolean controlFlags, Boolean scale, Boolean index, Boolean base);
...
void _Compile_CallThru(Boolean reg, Boolean regOrMem);
void Compile_CallThru_AdjustRSP(Boolean reg, Boolean regOrMem);
void Compile_Call(byte *address);
void _Compile_Call_ToAddressThruReg_TestAlignRSP(Boolean thruReg);
...
void _Compile_Stack_Push(Boolean stackReg, int64 obj);
...
void BI_CompileRecord_TestCode_ArgRegNum(BlockInfo *bi, Boolean argRegNum);
...
void Compiler_BI_CompileRecord_TestCode_Set_setTtnn(Compiler *compiler, Boolean reg, Boolean setTtn, Boolean setNegFlag, Boolean jccTtt, Boolean jccNegFlag);
...
void _Compile_SETcc_setTtnn_REG(Compiler *compiler, Boolean setTtn, Boolean setNegFlag, Boolean jccTtt, Boolean jccNegFlag, Boolean reg, Boolean rm);
void Compile_Cmp_Set_setTtnn_Logic(Compiler *compiler, Boolean setTtn, Boolean setNegateFlag, Boolean jccTtt, Boolean jccNegFlag);
...
void BI_Compile_Jcc(BlockInfo *bi, Boolean setTtn, byte *address);
...
DObject *_CfrTil_Do_DynamicObject_ToReg(DObject *dobject0, Boolean reg);
void CfrTil_Do_DynamicObject(DObject *dobject0, Boolean reg);
...
void Setup_MachineCodeInsnParameters(Compiler *compiler, Boolean direction, Boolean mod, Boolean reg, Boolean rm, int64 disp, int64 immediate, Boolean immSize, Boolean forceSet);
...
byte *Debugger_PrepareDbgSourceCodeString(Debugger *debugger, Word *word, byte *token0, int64 twAlreayUsed);
...
Word *_Word_New(byte *name, uint64 ctype, uint64 ctype2, uint64 ltype, Boolean addToInNs, Namespace *addToNs, uint64 allocType);
...
int64 _LO_Apply_NonMorphismArg(LambdaCalculus *lc, ListObject **pl1, int64 i);
...
/* basis/lc/print.c */
byte *_LO_Print_Lambda_ToString(ListObject *l0, byte *buffer, int64 printValueFlag);
byte *_LO_Print_NonLambdaSymbol_ToString(ListObject *l0, byte *buffer, int64 printValueFlag);
