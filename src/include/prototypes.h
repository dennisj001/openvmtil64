...
void _Compile_ImmDispData(int64 immDisp, int64 immSize, int8 forceFlag);
...
void _Compile_MoveImm(int8 direction, int8 rm, int8 controlFlags, int8 sib, int64 disp, int64 imm, int8 immSize);
void _Compile_MoveImm_To_Reg(int8 reg, int64 imm, int8 immSize);
