...
void _Compile_MoveMem_To_Reg(int8 reg, byte *address, int8 iSize);
void _Compile_MoveMem_ToReg_ThruReg(int8 reg, byte *address, int8 iSize, int8 thruReg);
void _Compile_MoveReg_ToMem(int8 reg, byte *address, int8 iSize);
void _Compile_MoveReg_ToMem_ThruReg(int8 reg, byte *address, int8 iSize, int8 thruReg);
...
void _Compile_Set_CAddress_WithRegValue(byte *address, int8 reg);
...
Word *_Word_New(byte *name, uint64 ctype, uint64 ltype, int8 addToInNs, Namespace *addToNs, uint64 allocType);
...
void _Debugger_ShowSourceCodeAtAddress(Debugger *debugger, byte *address);
...
Word *_DObject_New(byte *name, uint64 value, uint64 ctype, uint64 ltype, uint64 ftype, byte *function, int64 arg, int8 addToInNs, Namespace *addToNs, uint64 allocType);
...
Namespace *CfrTil_Attribute_New(void);
void CfrTil_Attributedef(void);
