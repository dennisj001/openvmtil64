...
void _CfrTil_Do_LiteralWord(Word *word);
...
Word *Compiler_LocalWord(Compiler *compiler, byte *name, int64 ctype, int64 allocType);
...
void CfrTil_ShowInfo(Word *word, byte *prompt, int64 signal);
...
byte CfrTil_ConvertTypeAttributeToTypeCode(uint64 attribute);
byte CfrTil_Convert_Word_TypeAttributeToTypeCode(Word *word);
byte *CfrTil_ExpandTypeSignature(Word *opWord, byte *buffer);
uint64 CfrTil_ConvertTypeSigCodeToAttribute(byte sigCode);
void CfrTil_TypeStackPrint(void);
void CfrTil_TypeError(Word *word);
void _CfrTil_TypeStackReset(void);
void CfrTil_TypeStackReset(void);
void CfrTil_TypeStackPush(Word *word);
void CfrTil_TypeStack_SetTop(Word *word);
Word *CfrTil_TypeStack_Pop(void);
void CfrTil_TypeStack_Dup(void);
void CfrTil_TypeCheckOn(void);
