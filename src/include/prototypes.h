...
int8 _CalculateModRmByte(int64 mod, int64 reg, int64 rm, int64 disp, int64 sib);
void _Compile_Displacement(int64 modRm, int64 disp);
int64 _CalculateSib(int64 scale, int64 indexReg, int64 baseReg);
byte _CalculateRex(int64 reg, int64 rm, int64 sib, int64 operandSize);
void _Compile_ModRmSibDisplacement(int8 modRm, int8 modRmFlag, int8 sib, int64 disp);
void _Compile_ImmediateData(int64 imm, int64 immSize);
void Compile_OpCode_Int8(int64 opCode);
int8 _Calculate_Rex(int8 reg, int8 rm, int8 operandSize);
void _Compile_InstructionX86(int64 opCode, int64 mod, int64 reg, int64 rm, int64 modFlag, int64 sib, int64 disp, int64 imm, int64 operandSize);
void _Compile_LEA(int64 reg, int64 rm, int64 sib, int64 disp);
void _Compile_X_Group1(int64 code, int64 toRegOrMem, int64 mod, int64 reg, int64 rm, int64 sib, int64 disp, int64 osize);
void _Compile_X_Group1_Immediate(int64 code, int64 mod, int64 rm, int64 disp, int64 imm, int64 iSize);
void _Compile_Op_Group1_Reg_To_Reg(int64 code, int64 dstReg, int64 srcReg);
void _Compile_Op_Special_Reg_To_Reg(int64 code, int64 rm, int64 reg);
void _Compile_Group2(int64 mod, int64 regOpCode, int64 rm, int64 sib, int64 disp, int64 imm);
void _Compile_Group2_CL(int64 mod, int64 regOpCode, int64 rm, int64 sib, int64 disp);
void _Compile_Group3(int64 code, int64 mod, int64 rm, int64 sib, int64 disp, int64 imm, int64 size);
void _Compile_IMULI(int64 mod, int64 reg, int64 rm, int64 sib, int64 disp, int64 imm, int64 size);
void _Compile_IMUL(int64 mod, int64 reg, int64 rm, int64 sib, int64 disp);
void _Compile_Test(int64 mod, int64 reg, int64 rm, int64 disp, int64 imm);
void _Compile_Group5(int64 code, int64 mod, int64 rm, int64 sib, int64 disp, int64 size);
void _Compile_Move_Reg_To_Reg(int64 dstReg, int64 srcReg);
void _Compile_MoveImm(int64 direction, int64 rm, int64 sib, int64 disp, int64 imm, int64 operandSize);
void _Compile_MoveImm_To_Reg(int64 reg, int64 imm, int64 iSize);
void _Compile_MoveImm_To_Mem(int64 reg, int64 imm, int64 iSize);
void _Compile_MoveMem_To_Reg(int64 reg, byte *address, int64 thruReg, int64 iSize);
void _Compile_MoveMem_To_Reg_NoThru(int64 reg, byte *address, int64 iSize);
void _Compile_MoveReg_To_Mem(int64 reg, byte *address, int64 thruReg, int64 iSize);
void _Compile_Move(int64 direction, int64 reg, int64 rm, int64 sib, int64 disp);
void _Compile_Move_Reg_To_Rm(int64 dstRmReg, int64 srcReg, int64 disp);
void _Compile_Move_AddressValue_To_EAX(int64 address);
void _Compile_Move_EAX_To_MemoryAddress(int64 address);
void _Compile_Move_Rm_To_Reg(int64 dstReg, int64 srcRmReg, int64 disp);
byte *Calculate_Address_FromOffset_ForCallOrJump(byte *address);
int64 _CalculateOffsetForCallOrJump(byte *compileAtAddress, byte *jmpToAddr);
void _SetOffsetForCallOrJump(byte *compileAtAddress, byte *jmpToAddr);
void _Compile_JumpToAddress(byte *jmpToAddr);
void _Compile_JumpToReg(int64 reg);
...
void _Compile_JCC(int64 negFlag, int64 ttt, uint64 disp);
void Compile_JCC(int64 negFlag, int64 ttt, byte *jmpToAddr);
void _Compile_Call(int64 callOffset);
void _Compile_CallThruMem(int8 reg);
void _Compile_CallThruReg(int8 reg);
void Compile_Call_With32BitDisp(byte *callAddr);
void Compile_Call_ToAddressThruReg(byte *address, int64 reg);
void Compile_Call(byte *address);
void _Compile_Call_NoOptimize(byte *callAddr);
void _Compile_TEST_Reg_To_Reg(int64 dstReg, int64 srcReg);
void _Compile_Return(void);
void _Compile_PushReg(int64 reg);
void _Compile_PopToReg(int64 reg);
...
void _Compile_MOVZX_REG(int64 reg);
...
void _Compile_MoveToR8AndCall(void);
...
void _Compile_Set_C_LValue_WithImm_ThruReg(int64 address, int64 value, int64 reg);
void _Compile_Get_C_Value_ToReg(int64 reg, int64 value);
void _Compile_Get_FromCAddress_ToReg_ThruReg(int64 reg, byte *address, int64 thruReg);
void _Compile_Get_FromCAddress_ToReg(int64 reg, byte *address);
void _Compile_Set_CAddress_WithRegValue_ThruReg(byte *address, int64 reg, int64 thruReg);
void Compile_Peek(Compiler *compiler, int64 stackReg);
void Compile_Store(Compiler *compiler, int64 stackReg);
void Compile_Poke(Compiler *compiler, int64 stackReg);
void Compile_AtEqual(int64 stackReg);
/* basis/compiler/combinators.c */
void CfrTil_EndCombinator(int64 quotesUsed, int64 moveFlag);
void CfrTil_BeginCombinator(int64 quotesUsed);
...
void _Compile_Stack_Drop(int64 stackReg);
void _Compile_Stack_DropN(int64 stackReg, int64 n);
void _Compile_DropN_ESP(int64 n);
void _Compile_SetStackN_WithObject(int64 stackReg, int64 n, int64 obj);
void _Compile_Stack_Push(int64 stackReg, int64 obj);
void _Compile_Move_StackN_To_Reg(int64 reg, int64 stackReg, int64 index);
void _Compile_Move_Reg_To_StackN(int64 stackReg, int64 index, int64 reg);
void _Compile_Move_StackNRm_To_Reg(int64 reg, int64 stackReg, int64 index);
void _Compile_Move_Reg_To_StackNRm_UsingReg(int64 stackReg, int64 index, int64 reg, int64 ureg);
void _Compile_Stack_PushReg(int64 stackReg, int64 reg);
void _Compile_Stack_PopToReg(int64 stackReg, int64 reg);
void Compile_Stack_PushEAX(int64 stackReg);
void Compile_Move_TOS_To_EAX(int64 stackReg);
void Compile_Move_EAX_To_TOS(int64 stackReg);
void Compile_Pop_To_EAX(int64 stackReg);
void Compile_Pop_ToEAX_AndCall(int64 stackReg);
void Compile_MoveImm_To_TOS(int64 stackReg, int64 imm, int64 size);
void _Compile_Stack_Dup(int64 stackReg);
void _Compile_Stack_Pick(int64 stackReg);
void _Compile_Stack_Swap(int64 stackReg);
void Compile_DataStack_PushEAX(void);
void _Compile_Esp_Push(int64 value);
...
void Compile_Cmp_Set_tttn_Logic(Compiler *compiler, int64 ttt, int64 negateFlag);
BlockInfo *_Compiler_Setup_BI_tttn(Compiler *compiler, int64 ttt, int64 negFlag, int64 overWriteSize);
void _Compile_SETcc(int64 ttt, int64 negFlag, int64 reg);
void _Compile_SET_tttn_REG(int64 ttt, int64 negFlag, int64 reg);
void Compile_GetLogicFromTOS(BlockInfo *bi);
int64 Compile_CheckReConfigureLogicInBlock(BlockInfo *bi, int64 overwriteFlag);
void _Compile_LogicResult(int64 reg);
...
void BlockInfo_Set_tttn(BlockInfo *bi, int64 ttt, int64 n, int64 overWriteSize);
...
void _MoveGotoPoint(dlnode *node, int64 srcAddress, int64 key, int64 dstAddress);
...
void Compile_X_Shift(Compiler *compiler, int64 op, int64 stackFlag);
...
void CfrTil_InterpretNBlocks(int64 blocks, int64 takesLParenAsBlockFlag);
void _CfrTil_C_Infix_EqualOp(Word *opWord);
/* basis/core/dataObjectNew.c */
Word *_DataObject_New(uint64 type, Word *word, byte *name, uint64 ctype, uint64 ltype, int64 index, int64 value, int64 startCharRlIndex);
byte *_CfrTil_NamelessObjectNew(int64 size, int64 allocType);
byte *CfrTil_NamelessObjectNew(int64 size);
...
void _CfrTil_MachineCodePrimitive_NewAdd(const char *name, uint64 cType, block *callHook, byte *function, int64 functionArg, const char *nameSpace, const char *superNamespace);
/* basis/cfrtil.c */
...
byte *_CfrTil_FinishSourceCode(CfrTil *cfrtil);
void CfrTil_FinishSourceCode(CfrTil *cfrtil, Word *word);
void _CfrTil_UnAppendFromSourceCode(CfrTil *cfrtil, int64 nchars);
...
byte *OVT_CheckRecyclableAllocate(dllist *list, int64 size);
...
void __CfrTil_Dump(int64 address, int64 number, int64 dumpMod);
...
dobject *_dllist_Push_M_Slot_Node(dllist *list, int64 dobjType, int64 allocType, int64 m_slots, ...);
...
Word *TC_Tree_Map_2(dllist *list, MapFunction mf, Word *iword);
...
int64 _Lexer_ConsiderDebugAndCommentTokens(byte *token, int64 evalFlag, int64 addFlag);
byte *_Lexer_NextNonDebugOrCommentTokenWord(Lexer *lexer, int64 evalFlag);
...
byte *_Lexer_LexNextToken_WithDelimiters(Lexer *lexer, byte *delimiters, int64 checkListFlag, uint64 state);
...
int64 _Stack_Pop_ExceptionFlag(Stack *stack, int64 exceptionOnEmptyFlag);
...
void Debugger_ParseFunctionLocalVariables(Debugger *debugger, Lexer *lexer);
...
void _Debugger_ShowEffects(Debugger *debugger, Word *word, int64 stepFlag);
void Debugger_ShowEffects(Debugger *debugger, int64 stepFlag);
byte *_String_HighlightTokenInputLine(byte *nvw, int64 lef, int64 leftBorder, int64 tokenStart, byte *token, int64 rightBorder, int64 ref, int64 dl);
...
byte *DelimitSourceCodeStartForLispCfrTil(char *sc);
...
uint64 _DataStack_Pop(void);
void _DataStack_Push(int64 value);
void _DataStack_Dup(void);
void _DataStack_DropN(int64 n);
...
int64 DataStack_Pop(void);
void CpuState_SyncStackPointersFromCpuState(Cpu *cpus);
void _Debugger_SyncStackPointersFromCpuState(Debugger *debugger);
...
void CfrTil_SyncStackPointersFromDsp(void);
...
int64 _Context_StrCmpNextToken(Context *cntx, byte *check);
void _Context_DoubleQuoteMacro(Context *cntx);
void CfrTil_DoubleQuoteMacro(void);
void _Tick(Context *cntx, int64 findWordFlag);
...
Word *_Word_Create(byte *name, uint64 ctype, uint64 ltype, uint64 allocType);
Word *_Word_New(byte *name, uint64 ctype, uint64 ltype, uint64 allocType);
...
void BigNum_SetDefaultBitPrecision(void);
void BigNum_StateShow(void);
void BigNum_FPrint(void);
void BigNum_EPrint(void);
void BigNum_PopTwoOpsPushResult(mpf2andOutFunc func);
...
CompileOptimizeInfo *CompileOptInfo_New(Compiler *compiler, uint64 type);
...
/* basis/sourceCode.c */
node *DWL_Check_SCWI(dlnode *node, byte *address, int64 scwi, Word *wordn, dlnode **maybeFoundNode, int64 *diff1);
dlnode *DWL_Find(Word *word, byte *address, byte *name, int64 fromFirst, int64 takeFirstFind, byte *newAddress);
void _Debugger_ShowSourceCodeAtAddress(Debugger *debugger);
dobject *DebugWordList_PushWord(Word *word);
void Debugger_SetDebugWordList(Debugger *debugger);
void CfrTil_SourceCodeBeginBlock(void);
void CfrTil_SourceCodeEndBlock(void);
void CfrTil_SourceCode_SetDebugWordList(Word *word);
void CfrTil_SourceCode_Begin_C_Block(void);
void CfrTil_SourceCode_End_C_Block(void);
void CfrTil_SourceCodeOff(void);
byte *PrepareSourceCodeString(byte *sc, Word *word, int64 scwi0);
...
void SC_DWL_PushCWL_Index(int64 index);
void CfrTil_DebugWordList_Pop(void);
void CfrTil_WordList_Pop(void);
void _CfrTil_WordLists_PopWord(int64 n);
void CfrTil_WordLists_PopWord(void);
void DWL_ShowNode(dlnode *node, byte *insert, int64 scwiDiff);
...
byte *__Debugger_CompileOneInstruction(Debugger *debugger, byte *jcAddress);
...
void _Debugger_SetupStepping(Debugger *debugger, Word *word, byte *address, byte *name, int64 iflag);
void Debugger_SetupStepping(Debugger *debugger, int64 iflag);
int64 Debugger_SetupReturnStackCopy(Debugger *debugger, int64 size);
void Debugger_PrintReturnStackWindow(void);
void Debugger_Compile_Restore_Runtime_DebuggerCpuState(Debugger *debugger, int64 showFlag);
void CfrTil_Compile_RestoreCCompileTimeCpuState(CfrTil *cfrtil, int64 showFlag);
void CfrTil_Compile_SaveCCompileTimeCpuState(CfrTil *cfrtil, int64 showFlag);
void Debugger_Compile_Save_RunTime_DebuggerCpuState(Debugger *debugger, int64 showFlag);
...
void Debug_ExtraShow(int64 size, int64 force);
/* basis/core/string.c */
...
int64 stricmp(byte *str0, byte *str1);
int64 StrnCmp(byte *str0, byte *str1, int64 n);
...
int64 String_FindStrnCmpIndex(byte *sc, byte *name0, int64 *i_ptr, int64 index0, int64 wl0, int64 inc);
...
OpenVmTil *_OpenVmTil_New(OpenVmTil *ovt, int64 argc, char *argv[ ], struct termios *savedTerminalAttributes);
void OVT_ShowNBAs(OpenVmTil *ovt, int64 flag);
int64 _OVT_ShowPermanentMemList(OpenVmTil *ovt, int64 flag);
int64 _Calculate_TotalNbaAccountedMemAllocated(OpenVmTil *ovt, int64 flag);
...
dobject *_dobject_New_M_Slot_Node(int64 allocType, int64 dobjType, int64 m_slots, ...);
...
Word *_DObject_Init(Word *word, uint64 value, uint64 ftype, byte *function, int64 arg, int64 addToInNs, Namespace *addToNs);
Word *_DObject_New(byte *name, uint64 value, uint64 ctype, uint64 ltype, uint64 ftype, byte *function, int64 arg, int64 addToInNs, Namespace *addToNs, uint64 allocType);
...
void Debugger_Disassemble(Debugger *debugger, byte *format, byte *address, int64 cflag);
...
void _OVT_Throw(int64 restartCondition);
...
void CfrTil_Exception(int64 signal, int64 restartCondition);
...
void Debugger_CheckSaveCpuState(Debugger *debugger);
void Debugger_CheckSaveCpuStateShow(Debugger *debugger);
...
void CpuState_AdjustEdi(Cpu *cpu, uint64 *dsp, Word *word);
void Debugger_AdjustEdi(Debugger *debugger, uint64 *dsp, Word *word);
ByteArray *Debugger_ByteArray_AllocateNew(int64 size, uint64 type);
...
int64 _LO_Apply_Arg(ListObject **pl1, int64 applyRtoL, int64 i);
ListObject *_LO_Apply_ArgList(ListObject *l0, Word *word, int64 applyRtoL);
...
void _Print_Binary(byte *buffer, int64 n);
void Print_Binary(int64 n, int64 min, int64 max);
