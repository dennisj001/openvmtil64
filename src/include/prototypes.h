...
void _Compile_ImmDispData(int64 immDisp, int64 immSize);
void Compile_Int8(int64 opCode);
int8 _Calculate_Rex(int8 reg, int8 rm, int8 flag);
void _Compile_InstructionX86(int8 opCode, int8 mod, int8 reg, int8 rm, int8 controlFlag, int8 sib, int64 disp, int8 dispSize, int64 imm, int8 immSize);
void _Compile_InstructionX64(int8 rex, int8 opCode, int8 modRm, int64 controlFlag, int8 sib, int64 disp, int8 dispSize, int64 imm, int8 immSize);
void _Compile_LEA(int8 reg, int8 rm, int8 sib, int64 disp);
void _Compile_X_Group1(int64 code, int64 toRegOrMem, int64 mod, int8 reg, int8 rm, int8 sib, int64 disp, int64 osize);
void _Compile_X_Group1_Immediate(int64 code, int64 mod, int8 rm, int64 disp, int64 imm, int8 iSize);
...
void _Compile_Group3(int64 code, int64 mod, int8 rm, int8 sib, int64 disp, int64 imm, int64 size);
void _Compile_IMULI(int64 mod, int8 reg, int8 rm, int8 sib, int64 disp, int64 imm, int64 size);
void _Compile_IMUL(int64 mod, int8 reg, int8 rm, int8 sib, int64 disp);
void _Compile_Test(int64 mod, int8 reg, int8 rm, int64 disp, int64 imm);
void _Compile_Group5(int64 code, int64 mod, int8 rm, int8 sib, int64 disp, int64 size);
void _Compile_Move_Reg_To_Reg(int8 dstReg, int64 srcReg);
void _Compile_MoveImm(int8 direction, int8 rm, int8 sib, int64 disp, int64 imm, int8 immSize);
void _Compile_MoveImm_To_Reg(int8 reg, int64 imm, int8 iSize);
void _Compile_MoveImm_To_Mem(int8 reg, int64 imm, int8 iSize);
void _Compile_MoveMem_To_Reg(int8 reg, byte *address, int8 thruReg, int8 iSize);
void _Compile_MoveMem_To_Reg_NoThru(int8 reg, byte *address, int8 iSize);
void _Compile_MoveReg_To_Mem(int8 reg, byte *address, int8 thruReg, int8 iSize);
void _Compile_Move(int8 mod, int8 reg, int8 rm, int8 sib, int64 disp);
void _Compile_Move_Reg_To_Rm(int8 dstRmReg, int8 srcReg, int64 disp);
void _Compile_Move_AddressValue_To_R8(int64 address);
void _Compile_Move_R8_To_MemoryAddress(int64 address);
void _Compile_Move_Rm_To_Reg(int8 dstReg, int8 srcRmReg, int64 disp);
...
void _Compile_Get_FromCAddress_ToReg(int8 reg, byte *address);
...
void _Compile_CpuState_Restore(Cpu *cpu, int8 cStackRegFlag, int8 jmpRetFlag);
void Compile_CpuState_Restore(Cpu *cpu);
void Compile_CpuState_RestoreHere(Cpu *cpu);
Cpu *_CpuState_Copy(Cpu *dst, Cpu *src);
Cpu *CpuState_Copy(Cpu *cpu0, uint64 type);
Cpu *CpuState_New(uint64 type);
Cpu *_CpuState_SaveCurrent(void);
...
void _Compile_SET_tttn_REG(int8 ttt, int8 negFlag, int8 reg);
...
Word *_CfrTil_WordList_Top(void);
void CfrTil_WordList_Pop(void);
void _CfrTil_WordLists_PopWords(int64 n);
...
int64 _Debugger_SetupReturnStackCopy(Debugger *debugger, int64 size);
