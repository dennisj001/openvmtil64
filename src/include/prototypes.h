...
void _Compile_ImmDispData(int64 immDisp, int64 immSize, int8 immFlag);
void Compile_Int8(int64 opCode);
int8 _Calculate_Rex(int8 reg, int8 rm, int8 rex_w_flag);
...
void _Compile_Group3(int64 code, int64 mod, int8 rm, int8 controlFlag, int8 sib, int64 disp, int64 imm, int64 size);
...
void _Compile_MoveImm(int8 direction, int8 rm, int8 controlFlag, int8 sib, int64 disp, int64 imm, int8 immSize);
...
void _Compile_Call(byte *callAddr, int8 reg);
...
void _Compile_Rsp_Push(int64 value);
...
int64 _CfrTil_AdjustGotoPoint(int64 originalAddress);
...
void _CfrTil_CPrimitiveNewAdd(const char *name, block b, uint64 ctype, uint64 ctype2, uint64 ltype, const char *nameSpace, const char *superNamespace);
...
/* basis/sourceCode.c */
Word *DWL_Find(dllist *list, Word *iword, byte *address, byte *name, int64 fromFirst, int64 takeFirstFind, byte *newAddress);
...
node *CfrTil_WordList_PopNode(void);
void _CfrTil_WordList_PopWords(int64 n);
void CfrTil_WordLists_PopWord(void);
void DWL_ShowWord(Word *word, byte *insert, int64 scwiDiff);
...
void _Compile_Rsp_Restore(void);
void _Compile_Rsp_Save(void);
...
void GotoInfo_New(byte *lname, uint64 type);
void _CfrTil_CompileCallGotoPoint(byte *name, uint64 type);
