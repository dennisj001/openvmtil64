...
void Compiler_FinishWordDebugInfo(Compiler *compiler, Boolean flag);
...
void _CfrTil_SetSourceCodeWord(Word *word);
void CfrTil_SetSourceCodeWord(void);
...
void CfrTil_AsmModeOn(void);
void CfrTil_AsmModeOff(void);
void CfrTil_CompileMode(void);
void CfrTil_FinishWordDebugInfo(void);
