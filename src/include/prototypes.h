...
void _Compile_Jcc(int64 bindex, int8 overwriteFlag, int8 ttt);
...
BlockInfo *BI_Set_JccLogicCodeToHere(BlockInfo *bi);
BlockInfo *Set_JccLogicCode(Compiler *compiler);
...
void _Compile_GetTestLogicFromTOS(void);
...
void _BlockInfo_Setup_BI_tttn(BlockInfo *bi, int8 ttt, int8 negFlag, int8 overWriteSize);
