...
byte *Interpret_C_Until_Token3(Interpreter *interp, byte *end1, byte *end2, byte *end3, byte *delimiters);
...
void Interpret_PrefixFunction_Until_RParen(Interpreter *interp, Word *prefixFunction);
