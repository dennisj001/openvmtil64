...
ListObject *_LO_Read_DoSplice(ListObject *l0, ListObject *lnew);
ListObject *_LO_Read_DoToken(byte *token, int64 qidFlag, int64 scwi);
ListObject *_LO_Read_DoListObject(ListObject *l0, ListObject *lnew, int64 qidFlag, int64 scwi);
...
ListObject *_LO_New(uint64 ltype, uint64 ctype, uint64 ctype2, byte *value, Word *word, uint64 allocType, int64 rl_Index, int64 scwi);
void LO_Quote(void);
...
void LC_Read(void);
void LC_List_Interpret(dllist *list);
ListObject *LO_Eval(ListObject *l0);
void LC_Eval(void);
