...
void Lexer_Word_SetTypeNamespace(Lexer *lexer, Word *word);
...
void _Debugger_Locals_Show_Loop(Debugger *debugger, Stack *stack, Word *scWord);
...
void Compiler_FreeAllLocalsNamespaces(Compiler *compiler);
...
void RT_DebugRuntimeBreakpoint(void);
...
void Namespace_FreeNamespacesStack(Stack *stack);
