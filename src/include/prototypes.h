...
void dllist_Map_Indexed(dllist *list, int64 flag, int64 fromFirst, MapFunction2 mf);
...
/* basis/sourceCode.c */
Word *DWL_Find(dllist *list, Word *iword, byte *address, byte *name, int64 fromFirstFlag, int64 takeFirstFind, byte *newAddress);
...
void CfrTil_DbgSourceCode_Begin_C_Block(void);
...
void _CfrTil_DbgSourceCodeCompileOn(void);
void _CfrTil_DbgSourceCodeCompileOff(void);
...
void SourceCode_Init(CfrTil *cfrtil);
...
void CfrTil_Word_FinishSourceCode(CfrTil *cfrtil, Word *word);
