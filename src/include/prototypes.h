...
BlockInfo *_CfrTil_BeginBlock0(Boolean compileJumpFlag, byte *here);
...
byte *_Interpret_C_Until_Token3(Interpreter *interp, byte *end1, byte *end2, byte *end3, byte *delimiters);
...
void _CfrTil_DebugRuntimeBreakpoint(Boolean debugOnOnlyFlag);
