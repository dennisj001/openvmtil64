...
void Compile_Move_Rm_To_Reg(Boolean rm, Boolean reg, int64 disp);
...
void Compile_UninitializedJump(void);
...
void _BI_Set_setTtnn(BlockInfo *bi, Boolean setTtn, Boolean setNegFlag, Boolean jccTtt, Boolean jccNegFlag, byte *jccLogicCode);
...
void CfrTil_Do_Variable(Word *word, Boolean rvalueFlag, Boolean isForwardDotted, Boolean isReverseDotted);
void _Do_Compile_Variable(Word *word, Boolean rvalueFlag);
void _Do_LiteralValue(int64 value);
void CfrTil_Do_LiteralWord(Word *word);
...
void Compile_C_TypeDeclaration(byte *token1, int64 tsrli, int64 scwi, Boolean equalFlag);
...
void CfrTil_Do_LispSymbol(Word *word);
void Array_Do_AccumulatedAddress(int64 totalOffset);
void Do_AccumulatedAddress(byte *accumulatedOffsetPointer, int64 offset, Boolean rvalueFlag);
...
void Namespace_AddToNamespaces_SetUsing(Namespace *ns, Boolean headFlag, Boolean usingFlag);
...
Boolean _CfrTil_IsContainingNamespace(byte *name, byte *namespaceName);
...
void Compiler_SaveDebugInfo(Compiler *compiler);
void Compiler_DeleteDebugInfo(Compiler *compiler);
...
Word *CfrTil_FindInAnyNamespace(byte *name);
...
void CfrTil_Postfix_FindAny(void);
void CfrTil_UnsetQualifyingNamespace(void);
...
int64 ParameterVar_Offset(Word *word);
...
int64 Word_RemoveIfStringEqualName(Symbol *symbol, byte *name);
void _CfrTil_Namespaces_PurgeWordName(byte *name);
void CfrTil_Namespaces_PurgeWordName(void);
...
void _CfrTil_RightBracket(void);
