...
void _Do_C_Syntax_Variable(Word *word);
...
/* basis/core/dllist.c */
dobject *_dllist_PushNew_M_Slot_Node(dllist *list, int64 typeCode, int64 allocType, int64 m_slots, ...);
...
void _List_PushNew_1Value(dllist *list, int64 typeCode, int64 value, int64 allocType);
...
void Word_Set_ScIndex_RlIndex(Word *word, int64 tsrli, int64 scwi);
...
void _Interpreter_DoPrefixWord(Context *cntx, Interpreter *interp, Word *word, int64 tsrli, int64 scwi);
...
int64 Lexer_CheckForwardToStatementEnd_LValue(Lexer *lexer, Word *word);
...
void CfrTil_PrintStackDepth(void);
...
void CfrTil_InitSourceCode_WithName(CfrTil *cfrtil, byte *name, Boolean force);
void CfrTil_InitSourceCode_WithCurrentInputChar(CfrTil *cfrtil, Boolean force);
