...
Word *_DataObject_New(uint64 type, Word *word, byte *name, uint64 ctype, uint64 ctype2, uint64 ltype, int64 index, int64 value, int64 tsrli, int64 scwi);
...
void CfrTil_WordList_RecycleInit(CfrTil *cfrtil, Word *scWord, Boolean recycle, Boolean force, Boolean saveWord0);
...
int64 String_CheckWordSize(byte *str, int64 wl, Boolean lPunctFlag, Boolean rPunctFlag);
...
void LinuxInit(void);
/* basis/exception.c */
int64 _OpenVmTil_ShowExceptionInfo(int signal);
