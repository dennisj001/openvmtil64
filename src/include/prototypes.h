...
void CfrTil_If_ConditionalExpression(void);
...
void Namespace_Do_C_Type(Namespace *ns);
...
void CfrTil_AdjustLabels(byte *srcAddress);
...
void _Debugger_Locals_Show_Loop(Debugger *debugger, Compiler *compiler, Word *scWord);
void Debugger_ParseFunctionLocalVariables(Debugger *debugger, Compiler *compiler, Lexer *lexer, Boolean c_syntaxFlag);
void _Debugger_ReadLocals(Debugger *debugger, Compiler *compiler, Lexer *lexer, Word *scWord, byte *sc);
...
void Namespace_DoNamespace(Namespace *ns);
...
void Compiler_Word_SetCodingHere_And_ClearPreviousUseOf_Here_SCA(Word *word, Boolean clearPreviousFlag);
...
void SC_List_Set_NotInUseForSC(dlnode *node, byte *address);
void CfrTil_AdjustDbgSourceCode_ScInUseFalse(byte *address);
void _CfrTil_WordList_PushWord(Word *word, int64 inUseFlag);
...
void _CfrTil_StringMacros_Init(void);
...
void CfrTil_TypeStack_Drop(void);
...
Word *Compiler_LocalWord(Compiler *compiler, byte *name, int64 ctype, int64 ctype2, int64 ltype, int64 allocType);
