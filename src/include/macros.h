...
#define CompileMode (_Context_ ? ( GetState ( _Context_->Compiler0, COMPILE_MODE ) || ( _LC_ && GetState ( _LC_, ( LC_COMPILE_MODE ) ) ) ) : 0)
...
#define CompilerWordList_Push( word, inUseFlag ) _List_PushNew_ForWordList ( _CfrTil_->CompilerWordList, word, inUseFlag ) 
